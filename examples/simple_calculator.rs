...
fn main() -> Result<()> {
    ...
    CliBuilder::new()
        ...
        .register_sync_handler("subtract_handler", Box::new(SubtractCommand))
        .register_sync_handler("multiply_handler", Box::new(MultiplyCommand))
        .register_sync_handler("divide_handler", Box::new(DivideCommand))
        .register_sync_handler("history_handler", Box::new(HistoryCommand))
        .register_sync_handler("clear_handler", Box::new(ClearCommand))
        .register_sync_handler("last_handler", Box::new(LastCommand))
        .build()?
        .run()
}
